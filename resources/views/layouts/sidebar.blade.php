<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      <div class="sidebar-brand">
        <a href="index.html">data barang mpp</a>
      </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="{{ (request()->segment(1) == 'barang') ? 'active' : '' }}"><a  href={{ route('barang.index')}}><i class="fas fa-boxes"></i> <span> barang</span></a></li>
        <li class="{{ (request()->segment(1) == 'kategori') ? 'active' : '' }}"><a  href={{ route('kategori.index')}}><i class="fas fa-box"></i> <span>kategori</span></a></li>
        <li class="{{ (request()->segment(1) == 'tenan') ? 'active' : '' }}"><a  href="{{ route('tenan.index')}}"><i class="fas fa-building"></i> <span>nama ruangan</span></a></li>
        <li class="menu-header">laporan</li>
        <li class="{{ (request()->segment(1) == 'print') ? 'active' : '' }}"><a  href={{ route('print.index')}}><i class="fas fa-print"></i> <span>print</span></a></li>
        <li class="{{ (request()->segment(1) == 'printt') ? 'active' : '' }}"><a  href={{ route('printt.index')}}><i class="fas fa-print"></i> <span>print tenan</span></a></li>
        {{-- <li class="dropdown">
